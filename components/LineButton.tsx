...
export default function LineButton({ text, lineUrl, size = 'lg', className = '' }: LineButtonProps) {
  const sizeClasses = {
  ...
  return (
    <a
      ...
      className={`inline-flex items-center justify-center gap-2 bg-[#06C755] text-white font-bold rounded-full 
                  hover:bg-[#05b34b] transition-all duration-300 transform hover:scale-105 shadow-lg
